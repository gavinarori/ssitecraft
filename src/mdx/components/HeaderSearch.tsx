...
export default function HeaderSearch() {
  ...
  useEffect(() => {
    ...
    const filteredResults = initialResults.filter((initialResult) => {
      return initialResult.title.toLowerCase().includes(searchQuery.toLowerCase().trim())
    })

    setSearchResults(filteredResults)
  }, [searchQueryDebounced, initialResults])
